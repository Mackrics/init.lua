...
vim.keymap.set("n", "<C-c><C-c>",  "<Cmd>NeoSlimeSendLine<Cr>")
vim.keymap.set({"n", "i"}, "<C-cr>",      "<Cmd>NeoSlimeSendLine<Cr>")
vim.keymap.set("n", "<leader>s",   "<Cmd>NeoSlimeSendLine<Cr>")
vim.keymap.set("v", "<C-c><C-c>",  "<Cmd>NeoSlimeSendVisualSelection<Cr>")
vim.keymap.set("v", "<C-cr>",  "<Cmd>NeoSlimeSendVisualSelection<Cr>")
vim.keymap.set("v", "<leader>s",   "<Cmd>NeoSlimeSendVisualSelection<Cr>")
